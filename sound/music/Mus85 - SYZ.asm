...
; DAC Data
Mus85_SYZ_DAC:
	dc.b	dSnare, $06, $06, $06, $06, $06, $06, $04, $02, $04, dKick, $06

Mus85_SYZ_Loop00:
	smpsCall            Mus85_SYZ_Call00
	smpsLoop            $00, $03, Mus85_SYZ_Loop00
	dc.b	dKick, $08, dSnare, $06, dKick, dKick, $06, dSnare, dSnare, dSnare
	dc.b	$04, dKick, $06

Mus85_SYZ_Loop01:
	smpsCall            Mus85_SYZ_Call00
	smpsLoop            $00, $02, Mus85_SYZ_Loop01
	dc.b	dKick, $08, dSnare, $06, dKick, dKick, $0C, dSnare, dSnare, $06
	dc.b	$06, $06, $06, $10, $02, $04, dKick, $06
...
Mus85_SYZ_Loop03:
	smpsCall            Mus85_SYZ_Call00
	smpsLoop            $00, $02, Mus85_SYZ_Loop03
	dc.b	dKick, $08, dSnare, $06, dKick, dKick, $0C, dSnare, $0A, dKick
	dc.b	$0E

	dc.b	dSnare, $0A, dKick, $02, dSnare, $06, dSnare, dSnare, $06, $04
	dc.b	dKick, $06
