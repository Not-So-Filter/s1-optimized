...
.loop:
		...
		ld	a, zmake68kBank(Snd_Bank_Start)		; Set song bank to second music bank (default value)
...
DAC_Banks:
		...
		db	zmake68kBank(DAC_82_Data)
		db	zmake68kBank(DAC_83_Data)
		db	zmake68kBank(DAC_81_Data)
		db	zmake68kBank(DAC_81_Data)
		db	zmake68kBank(DAC_81_Data)
		db	zmake68kBank(DAC_81_Data)
...
zUpdateMusic:
		...
		cp	bgm_ExtraLife-bgm__First			; Is it still 1-Up?
		jr	nz, .check_fade_in				; Branch if not
		ld	a, (zMusicNumber)				; Get next music to play
		cp	bgm_ExtraLife						; Is it another 1-Up?
		jr	z, .clr_queue					; Branch if yes
		cp	bgm__Last-bgm__First					; Is it music (except credits song)?
...
;sub_4FB
zPlaySoundByIndex:
		cp	sfx_Sega						; Is this the SEGA sound?
		jp	z, zPlaySegaSound				; Branch if yes
		cp	bgm__Last						; Is this a music?
		jp	c, zPlayMusic					; Branch if yes
		cp	sfx__Last						; Is this a sound effect?
		jp	c, zPlaySound_CheckRing			; Branch if yes
		cp	flg__First					; Is it before the first fade effect?
		jp	c, zStopAllSound					; Branch if yes
		cp	flg__Last						; Is this after the last fade effect?
		jp	nc, zStopAllSound					; Branch if yes
		sub	flg__First					; If none of the checks passed, do fade effects.
...
;loc_558
zPlayMusic:
		sub	bgm__First								; Remap index from 1h-32h to 0h-31h (see also credits music, above)
		ret	m								; Return if negative (id = 0)
		push	af							; Save af
		cp	bgm_ExtraLife-bgm__First						; Is it the 1-up music?
...
.no_fade:
		ld	a, (zFadeToPrevFlag)			; Get fade-to-prev flag
		cp	bgm_ExtraLife-bgm__First						; Was it triggered by the 1-up song?
...
.loop:
	if fix_sndbugs
		...
		ld	a, bgm_ExtraLife-bgm__First					; a = 1-up id-1
...
z80_MusicBanks:
		...
		db	zmake68kBank(Music87)
		db	zmake68kBank(Music88)
		db	zmake68kBank(Music89)
		db	zmake68kBank(Music8A)
		db	zmake68kBank(Music8B)
		db	zmake68kBank(Music8C)
		db	zmake68kBank(Music8D)
		db	zmake68kBank(Music8E)
		db	zmake68kBank(Music8F)
		db	zmake68kBank(Music90)
		db	zmake68kBank(Music91)
		db	zmake68kBank(Music92)
		db	zmake68kBank(Music93)
...
z80_MusicPointers:
		dw	zmake68kPtr(Music81)
		dw	zmake68kPtr(Music82)
		dw	zmake68kPtr(Music83)
		dw	zmake68kPtr(Music84)
		dw	zmake68kPtr(Music85)
		dw	zmake68kPtr(Music86)
		dw	zmake68kPtr(Music87)
		dw	zmake68kPtr(Music88)
		dw	zmake68kPtr(Music89)
		dw	zmake68kPtr(Music8A)
		dw	zmake68kPtr(Music8B)
		dw	zmake68kPtr(Music8C)
		dw	zmake68kPtr(Music8D)
		dw	zmake68kPtr(Music8E)
		dw	zmake68kPtr(Music8F)
		dw	zmake68kPtr(Music90)
		dw	zmake68kPtr(Music91)
		dw	zmake68kPtr(Music92)
		dw	zmake68kPtr(Music93)
; ---------------------------------------------------------------------------
; ===========================================================================
; SFX Pointers
; ===========================================================================
...
z80_SFXPointers:
		dw	zmake68kPtr(SoundA0)
		dw	zmake68kPtr(SoundA1)
		dw	zmake68kPtr(SoundA2)
		dw	zmake68kPtr(SoundA3)
		dw	zmake68kPtr(SoundA4)
		dw	zmake68kPtr(SoundA5)
		dw	zmake68kPtr(SoundA6)
		dw	zmake68kPtr(SoundA7)
		dw	zmake68kPtr(SoundA8)
		dw	zmake68kPtr(SoundA9)
		dw	zmake68kPtr(SoundAA)
		dw	zmake68kPtr(SoundAB)
		dw	zmake68kPtr(SoundAC)
		dw	zmake68kPtr(SoundAD)
		dw	zmake68kPtr(SoundAE)
		dw	zmake68kPtr(SoundAF)
		dw	zmake68kPtr(SoundB0)
		dw	zmake68kPtr(SoundB1)
		dw	zmake68kPtr(SoundB2)
		dw	zmake68kPtr(SoundB3)
		dw	zmake68kPtr(SoundB4)
		dw	zmake68kPtr(SoundB5)
		dw	zmake68kPtr(SoundB6)
		dw	zmake68kPtr(SoundB7)
		dw	zmake68kPtr(SoundB8)
		dw	zmake68kPtr(SoundB9)
		dw	zmake68kPtr(SoundBA)
		dw	zmake68kPtr(SoundBB)
		dw	zmake68kPtr(SoundBC)
		dw	zmake68kPtr(SoundBD)
		dw	zmake68kPtr(SoundBE)
		dw	zmake68kPtr(SoundBF)
		dw	zmake68kPtr(SoundC0)
		dw	zmake68kPtr(SoundC1)
		dw	zmake68kPtr(SoundC2)
		dw	zmake68kPtr(SoundC3)
		dw	zmake68kPtr(SoundC4)
		dw	zmake68kPtr(SoundC5)
		dw	zmake68kPtr(SoundC6)
		dw	zmake68kPtr(SoundC7)
		dw	zmake68kPtr(SoundC8)
		dw	zmake68kPtr(SoundC9)
		dw	zmake68kPtr(SoundCA)
		dw	zmake68kPtr(SoundCB)
		dw	zmake68kPtr(SoundCC)
		dw	zmake68kPtr(SoundCD)
		dw	zmake68kPtr(SoundCE)
		dw	zmake68kPtr(SoundCF)
		dw	zmake68kPtr(SoundD0)
; ---------------------------------------------------------------------------
; ===========================================================================
; END OF SOUND DRIVER
; ===========================================================================
