...
; loc_71BBC:
.nosndinput:
		tst.b	v_sound_id(a6)	; is song queue set for silence (empty)?
...
.inputloop:
		...
		tst.b	v_sound_id(a6)	; Is v_sound_id a $80 (silence/empty)?
...
; loc_71F2C:
.havesound:
		andi.w	#$FF,d0			; Clear high byte and sign bit
...
Sound_PlaySFX:
		...
		bne.s	loc_722C6.clear_sndprio		; Exit is it is
		tst.b	v_fadeout_counter(a6)	; Is music being faded out?
		bne.s	loc_722C6.clear_sndprio		; Exit if it is
...
.clearramloop:
		...
		clr.b	v_sound_id(a6)	; set music to $00 (silence)
		bsr.s	FMSilenceAll
		bra.w	PSGSilenceAll
...
PSGDoVolFX:
 ...
 PSGDoVolFX_Loop:
		...
		bmi.s	VolEnvHold			; If value is negative, branch
; loc_72960:
.gotflutter:
