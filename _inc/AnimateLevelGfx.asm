...
.size		= 16	; number of tiles per frame
		...
		lea	(Art_GhzFlower1).l,a1 ;	load big flower	patterns
		lea	(v_128x128_end+$1000).w,a2 ; load 2nd big flower from RAM
		move.b	(v_lani1_frame).w,d0
		addq.b	#1,(v_lani1_frame).w ; increment frame counter
...
;		lsl.w	#8,d0		; multiply by $100
		...
		lea	(v_128x128_end+$1000+$400).w,a1 ; load	special	flower patterns	(from RAM)
		lea	(a1,d0.w),a1	; jump to appropriate tile
		moveq	#.size-1,d1
		bra.s	LoadTiles
; ===========================================================================
...
.size		= 16	; number of tiles per frame
		...
		lea	(v_128x128_end+$1000+$A00).w,a1 ; load	special	flower patterns	(from RAM)
		lea	(a1,d0.w),a1	; jump to appropriate tile
		moveq	#.size-1,d1
		bra.s	LoadTiles
; ===========================================================================
